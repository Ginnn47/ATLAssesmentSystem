...
SECRET_KEY = 'django-insecure-0#!9$(q+)wkp4g0y(zh9vwcvc0+c%y4*6g6%it#+zp@tgo8t(6'
...
INSTALLED_APPS = [
    ...
    'atlBackend.apps.AtlConfig',
]

MIDDLEWARE = [
    'django.middleware.security.SecurityMiddleware',
    'atlBackend.middleware.DevCorsMiddleware',
...
WSGI_APPLICATION = 'atlBackend.wsgi.application'
